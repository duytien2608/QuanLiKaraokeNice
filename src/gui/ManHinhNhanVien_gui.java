...
public class ManHinhNhanVien_gui extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ManHinhNhanVien_gui frame = new ManHinhNhanVien_gui();
	 ...
	 * @throws SQLException 
	 */
	public ManHinhNhanVien_gui() throws SQLException {
		setIconImage(Toolkit.getDefaultToolkit().getImage(ManHinhNhanVien_gui.class.getResource("/res/music-2-24.png")));
		...
		btn_DangXuat.setIcon(new ImageIcon(ManHinhNhanVien_gui.class.getResource("/res/account-logout-16.png")));
		...
		lblNewLabel_1.setIcon(new ImageIcon(ManHinhNhanVien_gui.class.getResource("/res/tenDangNhap.png")));
		...
		lblNewLabel_2.setIcon(new ImageIcon(ManHinhNhanVien_gui.class.getResource("/res/kara.png")));
		...
		lblNewLabel.setIcon(new ImageIcon(ManHinhNhanVien_gui.class.getResource("/res/background.jpg")));
